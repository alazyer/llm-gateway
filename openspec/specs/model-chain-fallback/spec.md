# model-chain-fallback Specification
...
For streaming requests resolved to a chain, the executor SHALL commit to the first model that produces an SSE chunk and SHALL NOT attempt fallback after that point:
