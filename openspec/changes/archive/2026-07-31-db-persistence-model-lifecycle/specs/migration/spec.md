...
This change does not support migrating from a pre-existing database created by a prior version of the gateway (there is no prior database implementation). Migration logic only handles schema evolution from this point forward.
