# configurable-model-prefix Specification

## Purpose
Define operator-configurable prefix allowlisting and channel visibility for extension-registered Copilot proxy models.
