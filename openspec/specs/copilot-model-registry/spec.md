# copilot-model-registry Specification

## Purpose
Define dynamic registration and discovery behavior for Copilot-backed models exposed through operator-allowed extension prefixes.
